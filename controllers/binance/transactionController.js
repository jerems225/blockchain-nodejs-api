...
async function estimategas(req,res)
{
    ...
    if(result)
    {
        ...
        const gasBnbgwei = gasgwei * gasLimit;
        const gasbnb = await web3.utils.fromWei(web3.utils.toWei(String(gasBnbgwei),'gwei'),'ether');


        var fast = gasbnb * 100;
        var fastest = gasbnb * 150;
        var average = gasbnb * 200;
        var safelow = gasbnb * 250;
